...
export const PixelImage = ({
  ...
  const pieces = useMemo(() => {
    ...
    return Array.from({ length: total }, (_, index) => {
      ...
      // Use deterministic pseudo-random based on index to avoid impure function call
      const pseudoRandom = Math.sin(index * 12.9898) * 0.5 + 0.5;
      const delay = pseudoRandom ** 2 * maxAnimationDelay; // Ease-in effect
      return {
        clipPath,
        delay,
      };
        ...
        <div
          ...
          <img
            ...
            className={cn(
              ...
              'z-1 object-cover overflow-hidden!',
              'w-full h-full',
